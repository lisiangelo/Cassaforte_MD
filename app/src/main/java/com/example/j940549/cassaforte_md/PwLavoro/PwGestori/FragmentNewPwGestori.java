 ...
 * {@link FragmentNewPwGestori.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentNewPwGestori#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentNewPwGestori extends Fragment {
    ...
    public FragmentNewPwGestori() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static FragmentNewPwGestori newInstance(String user, String applicazione,String tipo) {
        FragmentNewPwGestori fragment = new FragmentNewPwGestori();
...
//SharedPreferences sharedPref = getPreferences(Context.MODE_PRIVATE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view=inflater.inflate(R.layout.fragment_new_pw_gestori, container, false);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_backnavigation:
                        Fragment fragment=FragmentPwGestori.newInstance(user);
    ...
    public void inserisciNewPwLavoro(View view) throws Exception {
        ...
        if (!nomeApplicazione.equals("")&&!nomeUtente.equals("")&&!password.equals("")) {
            ...
            if(inserito) {
                ...
                /*Intent vaiaLavoro=new Intent(getActivity(), ViewGestori.class);
