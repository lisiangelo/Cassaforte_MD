...
import com.example.j940549.cassaforte_md.Login_Activity;
 ...
 * {@link FragmentNewPwBancheDati.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentNewPwBancheDati#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentNewPwBancheDati extends Fragment {
    ...
    public FragmentNewPwBancheDati() {
        // Required empty public constructor
    }

    // TODO: Rename and change types and number of parameters
    public static FragmentNewPwBancheDati newInstance(String user, String applicazione, String tipo) {
        FragmentNewPwBancheDati fragment = new FragmentNewPwBancheDati();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view=inflater.inflate(R.layout.fragment_new_pw_banche_dati, container, false);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_backnavigation:
                        Fragment fragment=FragmentPwBancheDati.newInstance(user);
...
/*        if (mListener != null) {
    ...
    public void inserisciNewPwLavoro(View view) throws Exception {
        ...
        Log.i("ins_pw",nomeApplicazione+nomeUtente+passwordinchiaro+SECURITYKEY);
        Crypto crypto= new Crypto(SECURITYKEY.getBytes());
        String password = crypto.encrypt(passwordinchiaro.getBytes());
        Log.i("ins_pw",nomeApplicazione+nomeUtente+passwordinchiaro+password );
