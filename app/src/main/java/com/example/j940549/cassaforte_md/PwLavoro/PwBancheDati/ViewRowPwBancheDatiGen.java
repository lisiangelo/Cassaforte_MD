...
public class ViewRowPwBancheDatiGen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.row_lavoro_icon_gen);

        idapp = getIntent().getExtras().getString("idApplicazione");
        user = getIntent().getExtras().getString("user");
        btnPhotoActivity= (Button) findViewById(R.id.btnCreaIconaLav);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_backnavigation:
                        Intent intent = new Intent(ViewRowPwBancheDatiGen.this, MainActivity.class);
...
//SharedPreferences sharedPref = getPreferences(Context.MODE_PRIVATE);
    ...
    public void apriPhotoIntent(View view) {
        ...
        vaiaPhotoIntentActivity.putExtra("tipoPassword","BANCHE_DATI");
        vaiaPhotoIntentActivity.putExtra("nomeApplicazione",editnomeApplicazione.getText().toString());
    ...
    public void modificaPwLavoro() throws Exception {
        ...
        if(ris==1){
            ...
            vaiaLavoro.putExtra("qualeFragment","pwPersonali");
