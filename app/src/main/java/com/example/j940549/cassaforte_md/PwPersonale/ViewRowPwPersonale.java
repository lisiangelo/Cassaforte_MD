...
import com.example.j940549.cassaforte_md.CambiaPassword;
...
public class ViewRowPwPersonale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.row_personale);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_backnavigation:
                        Intent intent = new Intent(ViewRowPwPersonale.this, MainActivity.class);
