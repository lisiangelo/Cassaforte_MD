...
public class ViewRowPwGestoriGen extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.action_backnavigation:
                        Intent intent = new Intent(ViewRowPwGestoriGen.this, MainActivity.class);
...
//SharedPreferences sharedPref = getPreferences(Context.MODE_PRIVATE);
    ...
    public void apriPhotoIntent(View view) {
        ...
        vaiaPhotoIntentActivity.putExtra("tipoPassword","GESTORI");
